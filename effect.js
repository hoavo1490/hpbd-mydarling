...
$('document').ready(function(){
	...
	$('#wish_message').click(function(){
		...
		$('#b77').animate({top:240, left: vw+200},500);
		$('#b88').animate({top:240, left: vw+300},500);	
		$('#b99').animate({top:400, left: vw+100},500);		
		$('#b1010').animate({top:380, left: vw+158},800);							
	...
	$('#story').click(function(){
		...
		$('#b99').animate({top:240, left: vw+450},500).promise().done(function(){
			$('.message').fadeIn('slow');
		});
		$('#b1010').animate({top:220, left: vw+508},800).promise().done(function(){
			$('.message').fadeIn('slow');
		});
		var i;
